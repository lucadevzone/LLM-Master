...
3. **Aggancio narrativo**
   ...
   - Può essere una sensazione, un suono, una presenza — qualcosa di concreto

## Cosa NON fare

- Non elencare meccanicamente gli eventi — racconta, non riferire
- Non aprire una nuova scena con NEW_SCENE in questa fase
- Non chiedere ai giocatori di agire prima di aver completato il riepilogo

## Transizione

Quando il riepilogo è completo, usa `SET_CYCLE_PHASE: "impostare_scena"` per rientrare nel ciclo normale.
